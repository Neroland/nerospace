...
- the Nerospace version, NeoForge version and whether the game is a client or server,
...
Set the following in `config/nerospace-common.toml` (created on first launch):
