 ...
 * block's corner (the BER's pose origin), computed from the server-synced dig state in
...
public class QuarryControllerRenderState extends BlockEntityRenderState {
    ...
    public double hy;
    public double hz;
    /** Tier accent (ARGB) for the gantry rails + drill bit. */
    public int accent;
    /** Drill-bit spin (degrees). */
