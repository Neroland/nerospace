...
/**
 * Tier 4 rocket geometry: the heavy — a widened core with FOUR strap-on boosters, built for the
 * Heavy Launch Complex. Geometry-only holder, rendered via {@link RocketModel}.
 */
public final class RocketT4Model {

    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            Identifier.fromNamespaceAndPath(NerospaceCommon.MOD_ID, "rocket_t4"), "main");
