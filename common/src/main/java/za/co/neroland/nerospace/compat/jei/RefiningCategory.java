...
public class RefiningCategory extends AbstractRecipeCategory<RefiningCategory.RefiningRecipe> {
    ...
    public static final IRecipeType<RefiningCategory.RefiningRecipe> TYPE =
    ...
    public record RefiningRecipe(List<ItemStack> carbon,
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RefiningRecipe recipe,
            IFocusGroup focuses) {
    ...
    @Override
    public void createRecipeExtras(IRecipeExtrasBuilder builder, RefiningRecipe recipe,
            IFocusGroup focuses) {
