...
/**
 * The craftable launch mount (Phase 4): a short pad a rocket is assembled onto. A {@link RocketItem}
 * may only place a {@link RocketEntity} directly above one of these blocks, so the pad doubles as the
 * "assembly point" gate for a launch. Empty-hand right-click prints a formation report
 * (LAUNCH_PAD_DESIGN.md §5): cluster size, largest formed square, modules, and what is missing.
 */
public class RocketLaunchPadBlock extends Block {
    ...
    protected InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hit) {
        ...
        // interaction order tries it before Item#useOn), and consuming the click here would
        // swallow rocket-item deployment onto the pad.
