...
**quadruples** oxygen drain): the **Thermal Suit** (T2 piece + 4 Cindrite) for Cindara's heat and the
**Cryo Suit** (T2 piece + 4 Glacite) for Glacira's cold. All four pieces must match for the shield to
