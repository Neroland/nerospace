...
| `fabric` | Fabric Loom `1.17.11` | ✅ **builds** (`fabric-api 0.152.1+26.2`) | confirm API pin |
| `neoforge` | ModDevGradle (NeoForge) | ⏳ needs NeoForge 26.2 userdev (beta on Maven / self-build) | NeoForge `26.1.2.76` |
...
## NeoForge on 26.2 (the one pending cell)
