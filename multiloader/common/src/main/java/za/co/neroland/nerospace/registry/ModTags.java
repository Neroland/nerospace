 ...
 * Fabric); mod-specific behaviour tags (oxygen sealing, terraform conversion) live in {@code nerospace}.
 * Pure {@link TagKey} constants — tag membership is data ({@code tags/**.json}).
 */
