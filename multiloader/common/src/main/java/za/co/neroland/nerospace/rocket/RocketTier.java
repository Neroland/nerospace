...
public enum RocketTier {
    ...
    /** Fuel consumed by a single launch, in millibuckets (clamped to the tank so a launch is always possible). */
    public int fuelPerLaunch() {
        return Math.min(this.fuelPerLaunch, this.fuelCapacity);
    }
