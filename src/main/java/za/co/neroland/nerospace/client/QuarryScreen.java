...
/**
 * Screen for the quarry controller: sci-fi panel with a power gauge, the dig state, current depth and
 * a fluid-buffer gauge, around the frame/module/output slots.
 */
public class QuarryScreen extends TexturedContainerScreen<QuarryMenu> {

    private static final Identifier TEXTURE =
            Identifier.fromNamespaceAndPath(Nerospace.MODID, "textures/gui/quarry.png");
    ...
    protected void extractForeground(GuiGraphicsExtractor g) {
        ...
        // Readout band between the output grid (ends y≈76) and the player inventory (y=126).
        ...
        // compact fluid bar to the right of the label
