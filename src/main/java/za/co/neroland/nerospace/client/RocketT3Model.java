...
/**
 * Tier 3 rocket geometry (ART_OVERHAUL_DESIGN.md §4.2): a stretched nose over a four-slab ring
 * skirt — the sleek long-range silhouette. Geometry-only holder, rendered via {@link RocketModel}.
 */
public final class RocketT3Model {

    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            Identifier.fromNamespaceAndPath(Nerospace.MODID, "rocket_t3"), "main");
