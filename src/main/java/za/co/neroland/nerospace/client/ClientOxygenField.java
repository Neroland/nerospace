 ...
 * {@link OxygenFieldSyncPayload}; read by the particle / haze / boundary visual layers and the HUD.
 * A plain data holder (no client-only imports) so it is safe to reference from common network code.
 */
