 ...
 *
 * <p>v1 keeps the loot table in code (sensible defaults) with a few config knobs in {@link
 ...
 * weighted bonus rolls drawn from existing raw ores and the rarer alien items.</p>
 */
