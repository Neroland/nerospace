...
/**
 * Region-of-interest spacing + density cap (player request). The world is divided into square
 * <b>region cells</b> ({@link #CELL_CHUNKS}×{@link #CELL_CHUNKS} chunks). Each cell deterministically
 * gets <b>at most one</b> ROI — and which kind (hamlet / ruin / mega-city, or nothing) is chosen by a
 * hash of the cell, with weights that keep the rarer ones rare. The ROI sits at a deterministic
 * "anchor" chunk inside the cell. This guarantees even spacing and a hard cap on how many structures
 * occupy any given area, regardless of the placement RNG.
 */
public final class StructureSpacing {
    ...
    public static boolean shouldPlace(BlockPos origin, Roi mine) {
        ...
        // Cell ROI assignment (weights out of 100): keeps cities very rare, ruins uncommon, hamlets
        // common, and most cells empty for breathing room.
        ...
        // Anchor chunk within the cell (kept off the very edge so footprints don't straddle cells).
