...
/**
 * The Village Core's building catalogue + quest table (ALIEN_VILLAGERS_DESIGN.md §4, §7). Phase 4
 * proved the teach-and-grow loop with building shells; Phase 5 makes them produce goods, adds fetch
 * quests, and (in the core) config-gated raids.
 */
